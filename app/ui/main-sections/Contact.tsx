...
export default function Contact() {
    ...
    return (
        <div 
            ...
            ref={contactRef}
        >
            <div className="w-full flex items-center justify-center gap-1 mt-3 mb-3">
            ...
            <div className="w-full flex justify-center">
                <h2 className="text-[60px] text-thirdColor font-bold mt-0">
                    Get In Touch
                </h2>
            </div>
            <div className="w-full flex justify-center">
                <p className="m-0 text-lg text-center text-sixthColor">
